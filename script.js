...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.references__item', '.references__arrow_left', '.references__arrow_right');
...
var modal = function modal() {
  function bindModal(btnTrigger, modalTrigger, closeTrigger) {
    var btn = document.querySelector(btnTrigger),
...
var slider = function slider(slideSelector, prevArr, nextArr) {
  var slideIndex = 1,
